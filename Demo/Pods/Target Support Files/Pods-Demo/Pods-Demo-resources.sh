...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "FlashPollsSDK/FlashPolls.framework/close.png"
  install_resource "FlashPollsSDK/FlashPolls.framework/close@2x.png"
  install_resource "FlashPollsSDK/FlashPolls.framework/FPNotificationActionCell.nib"
  install_resource "FlashPollsSDK/FlashPolls.framework/FPNotificationHeaderCell.nib"
  install_resource "FlashPollsSDK/FlashPolls.framework/FPNotificationTextCell.nib"
fi
